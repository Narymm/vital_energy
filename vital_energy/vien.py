...
async def start(update: Update, context: CallbackContext) -> int:
    with open(WELCOME_PHOTO_PATH, 'rb') as photo:
        await context.bot.send_photo(
            ...
            photo=photo,
            caption='<b>Как раскачать свою ЭНЕРГИЮ для успешной реализации? И не идти на поводу апатии и выгорания?!</b>\n\n<i>Ответ прост - надо ⚡️узнать <b>СЕБЯ</b> лучше.</i>\n\nБлагодаря астро-боту вы познакомитесь с важными действиями, которые являются для вас <b>ЖИЗНЕННО</b> необходимыми, чтобы прийти к личной <b>РЕАЛИЗАЦИИ</b>👇🏼\n\n💫 <i>Я Наталия Бонум, профессиональный и дипломированный астролог. Помогаю вам найти <b>СЕБЯ</b>, свою вторую <b>ПОЛОВИНКУ</b>, решить вопрос с <b>ПЕРЕЕЗДом</b>, <b>КАРЬЕРОЙ</b> и <b>ФИНАНСАМИ</b>, и не только…</i> 💫',
            parse_mode='HTML',
...
async def handle_question(update: Update, context: CallbackContext) -> None:
    ...
    if current_state < len(questions):  # Учитываем, что последний вопрос - это вопрос о данных
        ...
        context.user_data['answers'] = []
        await query.message.reply_text('Присоединяйтесь к моему <a href="https://t.me/astro_nataly_bonum">ТГ-каналу</a> и <a href="https://www.instagram.com/nataly_bonum?igsh=MWo5emFvczUwaHUyNQ==">Инстаграмм</a>, где я делюсь астро-тенденциями и своей жизнью.\nА также добро пожаловать на мой <a href="https://astronbonum.tilda.ws">сайт</a>.',
                                       parse_mode='HTML'
                                       )
        await query.message.reply_text('Приглашаю на первую <b><a href="https://astronbonum.tilda.ws/diagnostic">консультацию-диагностику</a></b> по минимальной цене - <b>1500₽</b> 🎁\n\n✔️ <i>Вас ожидает профессиональный астрологический разбор</i>\n+\n✔️ <i>Индивидуальные компенсаторные рекомендации по вашей натальной карте</i>\n+\n✔️ <i>Сможете ближе познакомитесь со мной и со своей натальной картой</i>\n\n<b><a href="https://astronbonum.tilda.ws/diagnostic">Переходите!</a></b>\n\n<blockquote>Цена действительна при первом обращении, и в течение недели, после получения сообщения 🫶🏼</blockquote>\n\n<b>До встречи!❤️</b>',
                                       parse_mode='HTML'
                                       )
