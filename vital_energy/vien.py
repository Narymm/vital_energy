...
def main() -> None:
    ...
    job_queue.run_repeating(send_ping, interval=timedelta(seconds=47), first=timedelta(seconds=10), name="ping_job", data="chat_id")
